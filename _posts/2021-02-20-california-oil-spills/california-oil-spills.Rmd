...
- We will also need another geospatial dataset with numeric variables for each location that will we use to color the counties. Download data from CA DFW Oil Spill Incident Tracking [URL](https://gis.data.ca.gov/datasets/7464e3d6f4924b50ad06e5a553d71086_0/data)
